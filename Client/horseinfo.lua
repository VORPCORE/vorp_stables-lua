...
local function ShowHorseDetailsOnCard(iEntity, hModel)
    ...
    m_InfoCardData.tDataBinding.iInfoBox =
        iInfoBox                                                        -- Save data for the info box container for future use. This data is deleted on cleanup.
...
local function ShowAnimalDetailsOnCard(iEntity)
    ...
    DatabindingAddDataString(iInfoBox, 'itemLabel',
        GetStringFromHashKey(GetDiscoverableNameHashAndTypeForEntity(iEntity)))
